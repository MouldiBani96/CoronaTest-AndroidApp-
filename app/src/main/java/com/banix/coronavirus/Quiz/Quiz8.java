...
ArrayAdapter<CharSequence>adapter;
    ...
    public void GoToQuiz9(){
        ...
        intent.putExtra("ValueChecked6",quiz6);
        intent.putExtra("ValueChecked7",quiz7);
        intent.putExtra("ValueChecked8",Integer.toString(ValueSlected()));
    ...
    public Boolean CheckBoxSelect(){
        ...
        if(!idYes.isChecked()&&!idNo.isChecked()) {
            Toast.makeText(Quiz8.this, "ٌقم بإختيار نعم أم لا", Toast.LENGTH_LONG).show();
            return false;
        }else {
            return true;
        }
    ...
    public Boolean VerifBox(){
        ...
        if (NombreDeCheck == 1) {
            ...
            Toast.makeText(Quiz8.this, "يمكنك فقط تحديد مربع اختيار واحدا", Toast.LENGTH_LONG).show();
            return false;
        }
    }
