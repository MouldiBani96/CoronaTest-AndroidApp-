...
ArrayAdapter<CharSequence>adapter;
    ...
    public void GoToQuiz8(){
        ...
        intent.putExtra("ValueChecked7",Integer.toString(ValueSlected()));
    ...
    public Boolean CheckBoxSelect(){
        ...
        if(!idYes.isChecked()&&!idNo.isChecked()) {
            Toast.makeText(Quiz7.this, "ٌقم بإختيار نعم أم لا", Toast.LENGTH_LONG).show();
            return false;
        }else {
            return true;
        }
    ...
    public Boolean VerifBox(){
        ...
        if (NombreDeCheck == 1) {
            ...
            Toast.makeText(Quiz7.this, "يمكنك فقط تحديد مربع اختيار واحدا", Toast.LENGTH_LONG).show();
            return false;
        }
    }
